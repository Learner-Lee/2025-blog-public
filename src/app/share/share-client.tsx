...
export default function ShareClient({ initialList }: { initialList: Share[] }) {
	const [shares, setShares] = useState<Share[]>(initialList)
	const [originalShares, setOriginalShares] = useState<Share[]>(initialList)
	...
	return (
		<>
			<PasswordDialog
				...
				onConfirm={pwd => { setPrivateKey(pwd); handleSave() }}
			/>
